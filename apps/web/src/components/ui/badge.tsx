  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        neon:
          "border-primary/40 bg-primary/10 text-primary shadow-[0_0_8px_rgba(0,245,255,0.3)]",
        "neon-purple":
          "border-secondary/40 bg-secondary/10 text-secondary shadow-[0_0_8px_rgba(124,58,237,0.3)]",
      },
    },
    defaultVariants: {
      variant: "default",
